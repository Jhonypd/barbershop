...
const ServicesItems = ({ service, isAuthenticated, barbershop }: ServicesItemsProps) => {
            ...
            <div className="flex items-center justify-between mt-3">
              ...
              <Sheet>
                ...
                <SheetContent className="p-0 overflow-y-auto [&::-webkit-scrollbar]:hidden">
                  ...
                  {date && (
                    <div className="py-6 gap-3 overflow-x-auto flex px-5 border-t border-solid border-secondary [&::-webkit-scrollbar]:hidden">
                      {timeList.map((time) => (
                        <Button
